    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="diskID" DataSourceID="SqlDataSource1" InsertItemPosition="LastItem">
        ...
        <EditItemTemplate>
            <tr style="background-color: #008A8C; color: #FFFFFF;">
                ...
                <td>
                    <asp:Label ID="diskIDLabel1" ValidationGroup="edit" runat="server" Text='<%# Eval("diskID") %>' />
                </td>
                <td>
                ...
                <td>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ErrorMessage="Genre ID must be a number between 1 and 11" ValidationGroup="edit" ValidationExpression="([1-9]|1[01])" ControlToValidate="genreIDTextBox" CssClass="text-danger" Display="Dynamic"></asp:RegularExpressionValidator>
        ...
        <InsertItemTemplate>
            <tr style="">
                ...
                <td>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Gnere ID must be a number between 1 and 11" ValidationGroup="insert" ValidationExpression="([1-9]|1[01])" ControlToValidate="genreIDTextBox" CssClass="text-danger" Display="Dynamic"></asp:RegularExpressionValidator>
